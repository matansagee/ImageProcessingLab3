...
public class MyJavaCameraView extends JavaCameraView implements Camera.PictureCallback {
    ...
    public void setFps(int minFps, int maxFps){
    ...
    public List<int[]> getFpsList(){return mCamera.getParameters().getSupportedPreviewFpsRange();}
